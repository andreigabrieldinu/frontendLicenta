...
export default function Chat() {
  ...
  useEffect(() => {
    //Primesti date de la server trimise prin socket cu cheia receive_message
    socket.on("receive_message", (data) => {
      //Apoi va seta functia Load call back useEffect pentru a obtine datele
      setLoad(true);
    });
  }, []);
